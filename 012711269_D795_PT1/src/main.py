...
from dijkstra import find_shortest_path  #Import Dijkstra function
...
# Example: Find shortest path from Ambulance 1 to first call
...
cost, path = find_shortest_path(graph, ambulance_location, call_location)

print("🛣️ Shortest Path:")
print(" → ".join(path))
